...
public class SingleCheckRecyclerAdapter extends CheckableChildRecyclerViewAdapter<HeadingViewHolder, CategoriesViewHolder> {


    public SingleCheckRecyclerAdapter(List<SingleCheckGenre> groups) {
        super(groups);
    }
